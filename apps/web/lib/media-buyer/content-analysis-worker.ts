...
function buildSystemPrompt(): string {
  return [
    ...
    "Calibrate scores strictly: 90-100 is exceptional and should be rare (normally under 5%); 75-89 is strong but has identifiable weaknesses; 55-74 is ordinary/test-only; below 55 is weak.",
    "Do not award 80+ merely because the image is clear, the caption has a price, or a CTA exists. Reserve 80+ for a strong hook, clear offer, audience fit, and persuasive sales path together.",
    "Confidence describes confidence in the content classification only. It is never proof of ad performance, sales, ROAS, or profit without measured Meta results.",
    ...
    "primaryText ทั้ง 5 แบบต้องเขียนคนละโครงสร้างและคนละมุมขายอย่างชัดเจน ห้ามคัดลอกข้อความก้อนเดียวกันแล้วเปลี่ยนเพียงประโยคท้าย และห้ามสร้างราคา โปรโมชั่น คุณสมบัติ หรือเงื่อนไขที่ไม่มีในโพสต์",
    "เขียน primaryText แต่ละแบบเป็น Sales Copy ภาษาไทยสำหรับ Meta Ads ความยาวประมาณ 450-900 ตัวอักษร ต้องมี Hook ที่น่าสนใจ ความต้องการหรือปัญหาของลูกค้า ประโยชน์ที่ได้รับ ข้อมูลข้อเสนอที่ยืนยันได้ และ CTA ให้ทักแชต ใช้ภาษาขายที่เป็นธรรมชาติและอ่านง่าย ไม่ใช่เพียงสรุปข้อความโพสต์เดิม",
    "AI สามารถคิดสำนวน มุมเล่าเรื่อง กลุ่มการใช้งาน และประโยชน์เชิงการตลาดใหม่ได้ แต่ห้ามแต่งข้อเท็จจริงที่ตรวจสอบได้ เช่น ราคา ส่วนลด จำนวนขั้นต่ำ วัสดุ ระยะผลิต การรับประกัน หรือผลลัพธ์เกินจากข้อมูลในโพสต์",
